...
class IGroup(Interface):
    ...
    def receive(sender, recipient, message):
        ...
        attempted for all registration.
        """
    ...
    def iterusers():
        """Return an iterator of all registration in this group."""
...
class IChatClient(Interface):
    ...
    name = Attribute(
        "A short string, unique among registration.  This will be set by the L{IChatService} at login time."
    )
...
class IUser(Interface):
    ...
    name = Attribute("A short string, unique among registration.")
...
class IChatService(Interface):
    ...
    createUserOnRequest = Attribute(
        ...
        "create registration which are requested but which do not yet exist."
    )
