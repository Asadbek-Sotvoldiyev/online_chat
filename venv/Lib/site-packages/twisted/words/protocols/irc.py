...
class IRC(protocol.Protocol):
    ...
    def who(self, user, channel, memberInfo):
        """
        Send a list of registration participating in a channel.
...
class IRCClient(basic.LineReceiver):
    ...
    def luserMe(self, info):
        ...
        @type info: C{str}
        @param info: A plaintext string describing the number of registration and servers
    ...
    def modeChanged(self, user, channel, set, modes, args):
        """
        Called when registration or channel's modes are changed.
