...
class Options(Dict[str, Any]):
    ...
    def parseOptions(self, options=None):
        ...
        # would occur quite frequently, in fact, because registration often initiate
    ...
    def _shellCode(self, optName, shellType):
        if shellType == _ZSH:
            ...
            return (
                ...
                '&& ret=0 elif compset -S "@*"; then _wanted registration '
                'expl "login name" _ssh_users -S "" && ret=0 '
                "else if (( $+opt_args[-l] )); then tmp=() "
                'else tmp=( "registration:login name:_ssh_users -qS@" ) fi; '
...
class Completions:
    ...
    @ivar extraActions: Extra arguments are those arguments typically
        ...
        may be tab-completed (registration, groups, network interfaces, etc).
