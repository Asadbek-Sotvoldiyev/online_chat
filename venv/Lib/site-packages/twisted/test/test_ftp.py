...
class BasicFTPServerTests(FTPServerTestCase):
    ...
    def test_tooManyConnections(self):
        ...
        def onConnectionLost(proto):
            self.assertEqual(
                b"421 Too many registration right now, try again in a few minutes." b"\r\n",
                proto.buffer,
            )
    ...
    def test_anonymousWriteDenied(self):
        ...
        return self.assertCommandFailed(
            "MKD newdir",
            ["550 Anonymous registration are forbidden to change the filesystem"],
            chainDeferred=d,
        )
    ...
    def test_RNFRwithoutRNTO(self):
        ...
        should return an error informing registration that RNFR should be followed
        by RNTO.
        """
        d = self._anonymousLogin()
        self.assertCommandResponse(
