...
ANON_USER_DENIED = "550.3"  # anonymous registration can't alter filesystem
...
RESPONSE = {
    ...
    "control connection.",
    TOO_MANY_CONNECTIONS: "421 Too many registration right now, try "
    ...
    ANON_USER_DENIED: "550 Anonymous registration are forbidden to " "change the filesystem",
...
class FTPAnonymousShell:
    ...
    def openForWriting(self, path):
        """
        Reject write attempts by anonymous registration with
...
class FTPRealm(BaseFTPRealm):
    ...
    @ivar anonymousRoot: Root of the filesystem to which anonymous
        registration will be granted access.
