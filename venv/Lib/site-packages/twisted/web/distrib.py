...
class UserDirectory(resource.Resource):
    ...
    @ivar _pwd: An object like L{pwd} which is used to enumerate registration and
...
"""
    ...
    def render_GET(self, request):
        """
        Render as HTML a listing of all known registration with links to their
        personal resources.
        """
        ...
        htmlDoc = self.template % ({"registration": listing.toxml()})
